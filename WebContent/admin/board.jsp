...
<script type="text/javascript">
   $(document).ready(function(){
      $(".data").on("dblclick",function(){
          ...
          //alert(boardno);
          location.href="${path}/boardDetail.do?boardno="+boardno;
       });
			...
			<colgroup>
				...
				<col style="width:5%">
					...
					<tr style="vertical-align:middle">
						<th>내용</th>
						<td><input type="text" name="content" value="${param.content }" style="width:90%"></td>
						<td><input type="button" value="검색" class="btn btn-sm btn-outline-secondary"/>
            			</td>
					</tr>
			</table>
			</form>
