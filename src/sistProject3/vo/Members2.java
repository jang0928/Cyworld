...
public class Members2 {
	...
	public Members2(String mem_id, String mem_pass, String mem_name, Date mem_birth, String mem_pnumber, String mem_email,
	...
	public Members2(String mem_name, String gender) {
		super();
		this.mem_name = mem_name;
		this.gender = gender;
	}
